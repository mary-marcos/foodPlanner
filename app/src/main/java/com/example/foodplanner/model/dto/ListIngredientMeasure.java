...
public class ListIngredientMeasure {

    public static ArrayList<IngredientMeasure> getIngridentsListArray(MealsDetail mealsDetail){
        ArrayList<IngredientMeasure> measurements = new ArrayList<>();
        setArray(mealsDetail,measurements);
        return measurements;
    }
    private static void setArray(MealsDetail mealsDetail, ArrayList<IngredientMeasure> measurements) {
    ...
    private static void addToArray(String strIngredient1, String strMeasure1, ArrayList<IngredientMeasure> measurements) {
        if (strIngredient1 != null && !strIngredient1.isEmpty()) {
            ...
            measurements.add(new IngredientMeasure(strIngredient1, measure));
        }
    }
}
