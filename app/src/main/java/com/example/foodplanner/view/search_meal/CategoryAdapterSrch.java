...
public class CategoryAdapterSrch extends RecyclerView.Adapter<CategoryAdapterSrch.ViewHolder> {
    List<CategoriesItem> categoriesItems;
    public OnCategoryClickListener onCategoryItemClickListener;
    Context context;

    public CategoryAdapterSrch(Context context , List<CategoriesItem> categoriesItems, OnCategoryClickListener onCategoryItemClickListener) {
